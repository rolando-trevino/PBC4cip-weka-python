...
# df.nlp_lemma = df.nlp_lemma.fillna(' ')
...
# Run function
selected_n = select_n_components(full_svd_ratios, 0.90)
print(selected_n)
...
visualizer = KElbowVisualizer(KMeans(random_state=0), metric='silhouette', k=range(2, 11, 1))
